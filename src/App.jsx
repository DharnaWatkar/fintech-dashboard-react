...
const App = () => {
  ...
  const users =[
    ...
    {
    img:'https://plus.unsplash.com/premium_photo-1661542463659-1597014336b8?q=80&w=735&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    color:'Blue',
    intro:'',
    tag:'Underbanked'
    },
